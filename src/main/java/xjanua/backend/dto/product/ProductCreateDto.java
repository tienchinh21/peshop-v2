...
/**
 * DTO for create and update product
 */
@Getter
@Setter
public class ProductCreateDto {
    ...
    @NotNull(message = "Category child is required")
    ...
    @Min(value = 0, message = "Classify must be greater than 0")
    @Max(value = 2, message = "Classify must be less than 2")
